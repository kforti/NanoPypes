...
To install NanoPypes, run this command in your terminal:

.. code-block:: console

    $ pip install nanopypes

This is the preferred method to install NanoPypes, as it will always install the most recent stable release.
